...
The following **binary frameworks** can be consumed through Swift Package Manager (SPM):
...
1. Ensure that your `.netrc` file is set up (see the [Authentication](#authentication) section above).
